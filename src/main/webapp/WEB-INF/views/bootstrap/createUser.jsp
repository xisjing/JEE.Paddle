		...
		<div class="row">
			<div class="col-md-8">
				<form:form action="create-user" modelAttribute="user"
					...
					<input name="username" type="text" maxlength="30" class="form-control"
					...
					<input name="birthdate" type="text" maxlength="30" class="form-control"
						placeholder="BirthDate" required value="${user.birthDate}" />
